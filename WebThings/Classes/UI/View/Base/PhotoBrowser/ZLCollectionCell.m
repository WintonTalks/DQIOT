...
- (void)layoutSubviews
{
    ...
    self.btnSelect.frame = CGRectMake(GetViewWidth(self.contentView)-25, 10, 15, 15);//GetViewHeight(self.contentView)-25
...
//        [self.btnSelect.layer addAnimation:GetBtnStatusChangedAnimation() forKey:nil];
//    }
    self.clickBlockVar = block;
    self.clickBlockVar(self.btnSelect.selected);
}
@end
